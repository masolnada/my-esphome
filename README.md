...
| **persiana-marc-piscina** | Shelly Plus 2 | 🪟 Cover — button (cycles up → stop → down → stop); direct relay control, **no cover entity** | `10.0.20.24` | `persiana-marc-piscina.local` | `persiana_marc_piscina/open` — toggle open relay<br>`persiana_marc_piscina/close` — toggle close relay |
| **persiana-marc-nord** | Shelly Plus 2 | 🪟 Cover — button (cycles up → stop → down → stop); direct relay control, **no cover entity** | `10.0.20.25` | `persiana-marc-nord.local` | `persiana_marc_nord/open` — toggle open relay<br>`persiana_marc_nord/close` — toggle close relay |
| **persiana-cuina-sud** | Shelly 2.5 | 🪟 Cover — button (cycles open → stop → close → stop) | `10.0.20.50` | `persiana-cuina-sud.local` | `persiana-cuina-sud/cover/blind/command` — `OPEN`/`CLOSE`/`STOP` (standard cover entity) |
| **persiana-cuina-pica** | Shelly 2.5 | 🪟 Cover — button (cycles open → stop → close → stop) | `10.0.20.51` | `persiana-cuina-pica.local` | `persiana-cuina-pica/cover/blind/command` — `OPEN`/`CLOSE`/`STOP` (standard cover entity) |
| **persiana-menjador** | Shelly 2.5 | 🪟 Cover — button (cycles open → stop → close → stop) | `10.0.20.52` | `persiana-menjador.local` | `persiana-menjador/cover/blind/command` — `OPEN`/`CLOSE`/`STOP` (standard cover entity) |
| **persiana-dormitori** | Shelly 2.5 | 🪟 Cover — 2 maintained switches (flip to open/close, flip back to stop) | `10.0.20.53` | `persiana-dormitori.local` | `persiana-dormitori/cover/blind/command` — `OPEN`/`CLOSE`/`STOP` (standard cover entity) |
| **persiana-bany** | Shelly 2.5 | 🪟 Cover — button (cycles open → stop → close → stop) | `10.0.20.56` | `persiana-bany.local` | `persiana-bany/cover/blind/command` — `OPEN`/`CLOSE`/`STOP` (standard cover entity) |
| **persiana-conills** | Shelly 2.5 | 🪟 Cover — 2 maintained switches (flip to open/close, flip back to stop) | `10.0.20.57` | `persiana-conills.local` | `persiana-conills/cover/blind/command` — `OPEN`/`CLOSE`/`STOP` (standard cover entity) |
| **persiana-habitacio-sud** | Shelly 2.5 | 🪟 Cover — 2 maintained switches (flip to open/close, flip back to stop) | `10.0.20.58` | `persiana-habitacio-sud.local` | `persiana-habitacio-sud/cover/blind/command` — `OPEN`/`CLOSE`/`STOP` (standard cover entity) |
